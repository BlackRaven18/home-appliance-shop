...
const Register = () => {
    ...
    const registerFacebookUser = (data) => {
        facebookFormData.name = data.first_name;
        facebookFormData.surname = data.last_name;
        facebookFormData.email = data.email;
        facebookFormData.password = data.id;
